    ...
    setWatchlist((prev) => {
      const updated = prev.map((stock) => {
        ...
        return {
          ...
          priceToSalesRatio: snapshot.priceToSalesRatio,
          priceToBookRatio: snapshot.priceToBookRatio,
          epsTtm: snapshot.epsTtm,
          totalRevenueTtm: snapshot.totalRevenueTtm,
          ...
          stockholdersEquity: snapshot.stockholdersEquity,
          grossMarginPercent: snapshot.grossMarginPercent,
          netMarginPercent: snapshot.netMarginPercent,
          freeCashFlowMarginPercent: snapshot.freeCashFlowMarginPercent,
          freeCashFlowYieldPercent: snapshot.freeCashFlowYieldPercent,
          debtToEquityPercent: snapshot.debtToEquityPercent,
          revenueGrowthYoYPercent: snapshot.revenueGrowthYoYPercent,
          earningsGrowthYoYPercent: snapshot.earningsGrowthYoYPercent,
          fundamentalsAsOf: snapshot.fundamentalsAsOf,
          ...
          distanceFrom52WeekHighPercent: snapshot.distanceFrom52WeekHighPercent,
